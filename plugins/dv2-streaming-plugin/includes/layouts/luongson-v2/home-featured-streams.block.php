 ...
 *
 * Optional: league_filter="1" enables competition dropdown + URL sync.
 *
    ...
    <div class="luongson-list-matches__header">
        ...
        <?php if ($league_filter) : ?>
            <div class="luongson-list-matches__league-filter" hidden>
                <button
                    type="button"
                    class="luongson-list-matches__league-btn"
                    aria-haspopup="listbox"
                    aria-expanded="false"
                    aria-label="<?php echo esc_attr__('Chọn giải đấu', 'dv2-streaming'); ?>"
                >
                    <span class="luongson-list-matches__league-btn-label"><?php echo esc_html__('Chọn giải', 'dv2-streaming'); ?></span>
                    <svg class="luongson-list-matches__league-btn-caret" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                ...
                <ul class="luongson-list-matches__league-menu" role="listbox" data-border="true" hidden></ul>
            </div>
        <?php endif; ?>
    </div>
