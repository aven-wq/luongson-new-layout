...
if ( ! $small_thumb && is_singular( 'post' ) && function_exists( 'luongson_get_single_primary_category' ) ) {
	$primary_term = luongson_get_single_primary_category();

	if ( $primary_term instanceof WP_Term && function_exists( 'luongson_category_has_small_thumb' ) ) {
...
$image_attrs = array(
	'class'    => 'ls-blog-s88 image-hover-scale-up',
	'decoding' => 'auto',
	'loading'  => 'lazy',
	'alt'      => $title,
	'sizes'    => $image_sizes,
