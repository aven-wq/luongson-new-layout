...
$bg_url   = luongson_asset_url( 'images/sidebar-bg.webp' );
?>
	...
	<div class="framer-QbuP0 framer-1ei7e2m framer-v-1ei7e2m ls-s2" data-border="true" data-framer-name="Desktop">
		<div class="framer-1omzemv ls-s3" data-framer-name="Image">
			<div class="ls-s4" data-framer-background-image-wrapper="true">
				<img class="ls-s5" alt="" decoding="async" loading="lazy" height="622" width="400" src="<?php echo esc_url( $bg_url ); ?>" />
			</div>
		</div>
			...
			<div class="framer-pr73oa ls-s6" data-framer-name="Logo">
				<div class="ls-s4" data-framer-background-image-wrapper="true">
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>" style="display:block;width:100%;height:100%;">
						<?php if ( $logo_url ) : ?>
						<img class="ls-s5" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" decoding="async" fetchpriority="high" height="<?php echo esc_attr( (string) $logo_h ); ?>" width="<?php echo esc_attr( (string) $logo_w ); ?>" src="<?php echo esc_url( $logo_url ); ?>" />
						<?php endif; ?>
					</a>
				</div>
			</div>
