 ...
 * @var string $label      Current page label.
 */
...
<div class="framer-1hhnbaz">
	<nav aria-label="<?php esc_attr_e( 'Breadcrumb', 'luongson' ); ?>" class="framer-18m6mx2" data-framer-name="Breadcrumb">
		<a class="framer-jokgij framer-2zqk9m" href="<?php echo esc_url( $home_url ); ?>">
			...
			<div class="framer-wudaff ls-blog-s98" data-framer-name="<?php echo esc_attr( $home_label ); ?>" data-framer-component-type="RichTextContainer">
				<p dir="auto" class="framer-text ls-blog-s101"><?php echo esc_html( $home_label ); ?></p>
			</div>
		</a>
		...
		<div class="framer-1jezyeg ls-blog-s98" data-framer-name="<?php echo esc_attr( $label ); ?>" data-framer-component-type="RichTextContainer">
			<p dir="auto" class="framer-text ls-blog-s103"><?php echo esc_html( $label ); ?></p>
		</div>
	</nav>
</div>
